    ...
    >
      <div className="container-custom flex justify-between items-center">
        ...
        <button 
          ...
          className="md:hidden bg-white/80 backdrop-blur-md p-2 rounded-lg text-secondary shadow-sm"
        >
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-lg absolute top-full left-0 right-0 shadow-sm">
